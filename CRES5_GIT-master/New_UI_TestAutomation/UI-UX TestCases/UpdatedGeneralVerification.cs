...
using CRES.TestAutoMation.UIUX_TestCases;
//using java.nio.file;
...
*/
                    ...
                    try
                    {
                        ...
                        Console.WriteLine("Actual Freq Element   = " + InvesotDetails);
                    ...
                    System.Threading.Thread.Sleep(5000);
                    bool ActualGeneralTerm = false;
                    try
                    {
                        ActualGeneralTerm = driver.FindElement(deal.ServicingDropDate).Displayed;

                        Console.WriteLine(" Interest Element    = " + ActualGeneralTerm);
                        addtolist(27,"Note ", "Actuals Tab ", ActualGeneralTerm);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (ActualGeneralTerm == false)
                        {
                    ...
                    try
                    {
                        ...
                        Console.WriteLine(" Defualt source element    = " + UPBAtForeclosure);
                        addtolist(28,"Note ", "Defualt Tab ", UPBAtForeclosure);

                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (UPBAtForeclosure == false)
                        {
...
/*
                    ...
                    try
                    {
                        ...
                        Console.WriteLine(" Note Rules Element    = " + NoteRulesHeading);
                        addtolist(32,"Note ", "Rules Tab ", NoteRulesHeading);
                                                
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (NoteRulesHeading == false)
                        {
                    ...
                    try
                    {
                        OthertabElement = driver.FindElement(deal.CommentsTags).Displayed;

                        Console.WriteLine(" Other-tab Element    = " + OthertabElement);
                        addtolist(33, "Note ", "Other Tab ", OthertabElement);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
