...
namespace CRES.TestAutoMation.Pages
{
    public class Deal
    {
        ...
        public By ReservesAccount = By.Id("anchortag-Reserves");
        ...
        public By AccountingCloseText = By.Id("anchortag-AccountingClose");
        ...
        public By dealID = By.Id("CRE_DealID");
        public By dealName = By.Id("Deal_Name");
        ...
        public By payrulePage = By.Id("anchortag-payrule");
        ...
        public By documentCheckElement = By.Id("anchortag-UploadDocument");
        public By activityTab = By.Id("aActivitytab");
        public By activityCheckElement = By.Id("anchortag-activity");
        ...
        public By Amortizationtab = By.Id("Amortization-tab");
        ...
        public By AmortizationElmnt = By.Id("anchortag-Amortization");
        ...
        public By exceptionElement = By.Id("anchortag-Exceptions");
        public By CommentsTags = By.Id("anchortag-CommentsTags");
        public By otherTab = By.Id("Other-tab");
        public By noteDocTab = By.Id("Documents-tab");
        public By noteDocTabElmnt = By.Id("anchortag-UploadDocument");
        public By noteUploadedDoc = By.Id("anchortag-Uploadeddocuments");
        public By noteActTab = By.Id("Activity-tab");
        public By noteActElement = By.Id("anchortag-activity");
        ...
        public By RulesRestButton = By.XPath("btnReset"); 
...
*//*
       public void SettlmntTab()
        ...
        {
            util.IsElementVisible(NoteDefaultTab);
        }
