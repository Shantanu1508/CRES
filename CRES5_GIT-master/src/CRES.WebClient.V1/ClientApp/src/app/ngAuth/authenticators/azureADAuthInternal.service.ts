...
import { AzureADServiceConstantsInternal } from "./AzureADServiceConstantsInternal.model";
import { JwtHelper } from '../JwtHelper';
import appsettings from '../../../../../appsettings.json';


@Injectable()
export class AzureADAuthServiceInternal {
  ...
  public LogOutall(state = "/internal") {
  ...
  // #docregion ctor
  constructor(private _serviceConstants: AzureADServiceConstantsInternal) {
