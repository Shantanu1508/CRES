...
export class ReportService {
  ...
  //==================== Api of Warehouse============================================//
  private _getwarehouseStatus: string = 'api/accountingreport/getwarehouseStatus';

  private _getrefreshentitydatatodw: string = 'api/note/getrefreshentitydatatodw';
  ...
  GetwarehouseStatus(btnname: string) {
    this.accountService.set(this._getwarehouseStatus);
    return this.accountService.post(JSON.stringify(btnname));
  }

  getrefreshentitydatatodw() {
