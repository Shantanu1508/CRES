...
exports.ReserveAccountSync = exports.DealRelationship = exports.PrincipalWriteoff = exports.ServicingPotentialWriteoffList = exports.AutoDistributeWriteoff = exports.LiabilityFundingSchedule = exports.LiabilityNoteAssetMapping = exports.DealLiabilityDataContract = exports.PrepayProjection = exports.FeeCredits = exports.MinMultSchedule = exports.SpreadMaintenanceSchedule = exports.PrepayAdjustment = exports.PrepaymentPremium = exports.AutoRepaymentNoteBalances = exports.AutoRepaymentBalances = exports.ProjectedPayoffDate = exports.AutoEquity = exports.DealAdjustedTotalCommitmentTab = exports.NoteAmort = exports.Amort = exports.NoteAmortization = exports.DealAmortization = exports.ServicingWatchlistDataContract = exports.AutoSpreadRule = exports.PayruleSetMaster = exports.NoteDetailFunding = exports.XIRRCalculationRequests = exports.NoteSequence = exports.Notefunding = exports.DealFunding = exports.deals = void 0;
var deals = /** @class */ (function () {
    function deals(DealID) {
        ...
        this.Listnoteid = [];
        this.ServicingPotentialImpairmentList = [];
        this.DeleteServicingPotentialImpairment = [];
        this.XIRROverride = [];
        this.dtPrepaymentGroup = [];
        this.dtPrepaymentNote = [];
        this.dtPrepaymentNoteAlloc = [];
        this.dtPayoffStatementFees = [];
        this.DealID = DealID;
...
var XIRRCalculationRequests = /** @class */ (function () {
    function XIRRCalculationRequests() {
    }
    return XIRRCalculationRequests;
}());
exports.XIRRCalculationRequests = XIRRCalculationRequests;
...
var ServicingWatchlistDataContract = /** @class */ (function () {
    function ServicingWatchlistDataContract() {
    }
    return ServicingWatchlistDataContract;
}());
exports.ServicingWatchlistDataContract = ServicingWatchlistDataContract;
...
var DealLiabilityDataContract = /** @class */ (function () {
    function DealLiabilityDataContract() {
    }
    return DealLiabilityDataContract;
}());
exports.DealLiabilityDataContract = DealLiabilityDataContract;
var LiabilityNoteAssetMapping = /** @class */ (function () {
    function LiabilityNoteAssetMapping() {
    }
    return LiabilityNoteAssetMapping;
}());
exports.LiabilityNoteAssetMapping = LiabilityNoteAssetMapping;
var LiabilityFundingSchedule = /** @class */ (function () {
    function LiabilityFundingSchedule() {
    }
    return LiabilityFundingSchedule;
}());
exports.LiabilityFundingSchedule = LiabilityFundingSchedule;
var AutoDistributeWriteoff = /** @class */ (function () {
    function AutoDistributeWriteoff() {
    }
    return AutoDistributeWriteoff;
}());
exports.AutoDistributeWriteoff = AutoDistributeWriteoff;
var ServicingPotentialWriteoffList = /** @class */ (function () {
    function ServicingPotentialWriteoffList() {
    }
    return ServicingPotentialWriteoffList;
}());
exports.ServicingPotentialWriteoffList = ServicingPotentialWriteoffList;
var PrincipalWriteoff = /** @class */ (function () {
    function PrincipalWriteoff() {
    }
    return PrincipalWriteoff;
}());
exports.PrincipalWriteoff = PrincipalWriteoff;
var DealRelationship = /** @class */ (function () {
    function DealRelationship() {
    }
    return DealRelationship;
}());
exports.DealRelationship = DealRelationship;
var ReserveAccountSync = /** @class */ (function () {
    function ReserveAccountSync() {
    }
    return ReserveAccountSync;
}());
exports.ReserveAccountSync = ReserveAccountSync;
