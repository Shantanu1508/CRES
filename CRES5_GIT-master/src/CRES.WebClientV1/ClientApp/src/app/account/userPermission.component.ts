...
export class userpermission {
  ...
  CheckDuplicateEmailLoginOnSave(): boolean {
    ...
    for (var i = 0; i < this.lstUsers.length; i++) {
      var emailarray = this.lstUsers.filter(x => x.Email == this.lstUsers[i].Email && x.Email != null && x.Email != "")
      if (emailarray.length > 1) {
        this._MsgTextUser = "Email <b>" + this.lstUsers[i].Email + "</b> already exist in the list.";
        isDuplicate = true;
        break;
      }
      var loginarray = this.lstUsers.filter(x => x.Login == this.lstUsers[i].Login && x.Login != null && x.Login != "")
  ...
  CheckMandatoryFieldsOnSave(): boolean {
    ...
    for (i = 0; i < this.lstUsers.length; i++) {
      ...
      if (
        ((this.lstUsers[i].FirstName === undefined || this.lstUsers[i].FirstName == "")
          || (this.lstUsers[i].LastName === undefined || this.lstUsers[i].LastName == "")
          || (this.lstUsers[i].Email === undefined || this.lstUsers[i].Email == "")
          || (this.lstUsers[i].Login === undefined || this.lstUsers[i].Login == "")) == true
        &&
        ((this.lstUsers[i].FirstName === undefined || this.lstUsers[i].FirstName == "")
          && (this.lstUsers[i].LastName === undefined || this.lstUsers[i].LastName == "")
          && (this.lstUsers[i].Email === undefined || this.lstUsers[i].Email == "")
          && (this.lstUsers[i].Login === undefined || this.lstUsers[i].Login == "")) == false
      ) {
        isRequired = true;
        ...
        if (this.lstUsers[i].ContactNo1 != undefined && this.lstUsers[i].ContactNo1 != "") {
          ...
          if (phonepattern.test(this.lstUsers[i].ContactNo1)) {
            this.lstUsers[i].ContactNo1 = this.lstUsers[i].ContactNo1.replace(/\D+/g, '').replace(/^(\d{3})(\d{3})(\d{4}).*/, '($1) $2-$3');
          }
          if (!phoneNumberPattern.test(this.lstUsers[i].ContactNo1)) {
            if (this.lstUsers[i].ContactNo1.length != 10 || !pattern.test(this.lstUsers[i].ContactNo1)) {
              isRequired = true;
    ...
    if (!this._MsgTextUser) {
      ...
      for (i = 0; i < this.lstApproverUser.length; i++) {
        for (j = 0; j < this.lstUsers.length; j++) {
          if (this.lstUsers[j].Email == this.lstApproverUser[i].Email) {
            break;
          }
        }
