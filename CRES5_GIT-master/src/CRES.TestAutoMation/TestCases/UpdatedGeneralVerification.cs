...
namespace CRES.TestAutoMation.TestCases
{
...

    {
        ...
        public void addtolist(int srno, string pagename, string tabname, Boolean res)
        {
                ...
                if (loginValidation)
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            addtolist(1,"deal", "Main", DealName);
                        }
                    ...
                    bool DealFundingschedule = false;


                    try
                    {
                        FundingRuleDisplay = driver.FindElement(deal.FundingRule).Displayed;
                        Console.WriteLine("Amortization Method = " + FundingRuleDisplay);
                        addtolist(2, "deal", "Funding", FundingRuleDisplay);

                        DealFundingschedule = driver.FindElement(deal.DealFundingSchedule).Displayed;
                        Console.WriteLine("Amortization Method = " + FundingRuleDisplay);
                        

                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (FundingRuleDisplay == false || DealFundingschedule == false)
                        {
                    ...
                    try
                    {
                        ...
                        AddLiabutton = driver.FindElement(deal.AddLiaButton).Displayed;
                        Console.WriteLine("Liability = " + AddLiabutton);


                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (DealLiabilitysetup == false || AddLiabutton == false)
                        {
                    ...
                    bool LiaGenSchedbutton = false;                    


                    try
                    {
                        LiaGenSchedbutton = driver.FindElement(deal.LiaGenSchedButton).Displayed;
                        Console.WriteLine("Liability Draws & Paydowns Tab  = " + LiaGenSchedbutton);
                        addtolist(4,"deal", "Liability Draws & Paydowns Tab", LiaGenSchedbutton);

                        AddLiabutton = driver.FindElement(deal.AddLiaButton).Displayed;
                        Console.WriteLine("Liability Draws & Paydowns Tab= " + AddLiabutton);


                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (LiaGenSchedbutton == false)
                        {
                    ...
                    try
                    {
                        ...
                        Console.WriteLine("Commitement/Equityt check  = " + TotalCommitmentCheck);
                        addtolist(6,"deal", "Commitement/Equity ", TotalCommitmentCheck);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        InvoicePage = driver.FindElement(deal.Invoice).Displayed;
                    ...
                    try
                    {
                        InvoiMaturityconfigcePage = driver.FindElement(deal.MaturityConfig).Displayed;
                        Console.WriteLine("Maturity Page  = " + InvoiMaturityconfigcePage);
                        addtolist(10,"deal", "Maturity", InvoiMaturityconfigcePage);

                        Viewhistory = driver.FindElement(deal.ViewHistory).Displayed;
                        Console.WriteLine("Maturity Page  = " + Viewhistory);


                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (InvoiMaturityconfigcePage == false || Viewhistory == false)
                        {
                    ...
                    {
                        Console.WriteLine("Special Servicing Tab exception = " + e);

                    }
                    Thread.Sleep(5000);

                    bool potentialImpairment = false;
                    ...
                    try
                    {
                        potentialImpairment = driver.FindElement(deal.PotentialImpairment).Displayed;
                        Console.WriteLine("Special Servicing Tab  = " + potentialImpairment);
                        addtolist(12,"deal", "Special Servicing Tab", potentialImpairment);

                        accounting = driver.FindElement(deal.Accounting).Displayed;
                        Console.WriteLine("Special Servicing Tab  = " + accounting);


                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (potentialImpairment == false || accounting == false)
                        {
                            printMessage += $"Message: <br>{"Special Servicing Tab Load Error"}<br>";
                            test.Fail(printMessage);
                        }
                        else
                        {
                            test.Log(Status.Pass, "Special Servicing Tab loaded sucessfully");
                        }
                    ...
                    bool rulesLogo = false;   

                    try
                    {
                        rulesLogo = driver.FindElement(deal.RulesLogo).Displayed;
                        Console.WriteLine("Rules Tab  = " + rulesLogo);
                        addtolist(13,"deal", "Rules Tab", rulesLogo);
                    ...
                    try
                    {
                        ...
                        addtolist(16,"deal", "Save Button ", SaveButton);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (SaveButton == false)
                        {
                    ...
                    try
                    {
                        ...
                        addtolist(17,"deal", "cancel Button ", CancelButton);
                    ...
                    try
                    {
                        ...
                        addtolist(18,"deal", "Copy Deal  Button ", CopyDealButton);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(19, "deal", "Download Button ", DownloadButton);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(20,"deal", "Admin Button ", AdminButton);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(21,"Note ", "Closing Tab ", actualFreqElmnt);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(22,"Note ", "Accounting Tab ", clientElement);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(23,"Note ", "Financing Tab ", financingFacElmnt);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(24,"Note ", "Settelment Tab ", closingDateElmnt);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(25,"Note ", "Deafult Tab ", effectiveDteElmnt);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(26,"Note ", "Servicing Tab ", servicingNameElmnt);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(27,"Note ", "Actuals Tab ", interestElement);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(28,"Note ", "PIK Tab ", pikSourceElement);
                    ...
                    try
                    {
                        ...
                        addtolist(29,"Note ", "Coupon Tab ", couponElement);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(30, "Note ", "Funding Tab ", noteFundingElemnt);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(31,"Note ", "Cashflow Tab ", periodicOtpButton);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    bool noteRulesLogo = false;
                    bool noteRulesLogoButton = false;

                    try
                    {
                        noteRulesLogo = driver.FindElement(deal.NoteRulesLogo).Displayed;
                        Console.WriteLine(" Note Rules Element    = " + noteRulesLogo);
                        addtolist(32,"Note ", "Rules Tab ", noteRulesLogo);
                                                
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                        if (noteRulesLogo == false)
                        {
                    ...
                    try
                    {
                        ...
                        addtolist(33,"Note ", "Exception Tab ", exceptionElement);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(34,"Note ", "Document Tab ", noteDocTabElmnt);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        ...
                        addtolist(35,"Note ", "Activity Tab ", noteActElement);
                        var printMessage = "<p><b>Test FAILED!</b></p>";
                    ...
                    try
                    {
                        driver.FindElement(deal.DebtJournalEntry).Click();
                        Thread.Sleep(3000);
                    ...
                    try
                    {
                        journalEntry = driver.FindElement(deal.DebtJournalEntry).Displayed;
        ...
        /* //Deal save generate funding
         ...
         public void dealSave()
         {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("\nsend Merge all files mail");
                    SendEmail.ValidationFile(path, "No Error.", driver);  // Check Point 
                }                      
        ...
        public void verifySearchBar()
        {
            ...
            if (sendValidationReportEmail.ToString().ToLower() == "yes")
            {
                try
                {
                    ...
                    //String times = UpdatedGeneralVerification.Timestamp();
