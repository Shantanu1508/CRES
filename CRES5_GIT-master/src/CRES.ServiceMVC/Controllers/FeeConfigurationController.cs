...
namespace CRES.Services.Controllers
{
    ...
    public class FeeConfigurationController : ControllerBase
    {
        ...
        [Services.Controllers.IsAuthenticate]
        [Services.Controllers.DeflateCompression]
        [Route("api/feeconfiguration/addupdatefeeconfigliability")]
        public IActionResult AddupdateFeeConfigLiability([FromBody] FeeConfigDataContract feeConfigDC)
        {
            GenericResult _actionResult = null;
            IEnumerable<string> headerValues;
            string Validationmessage = string.Empty;
            ...
            try
            {
                ...
                if (feeConfigDC != null && feeConfigDC.lstFeeFunctionsConfig != null && feeConfigDC.lstFeeFunctionsConfig.Count() > 0)
                {
                    _feeLogic.SaveFeeFunctionsConfigLiability(new Guid(headerUserID), feeConfigDC.lstFeeFunctionsConfig);
                }
                if (feeConfigDC != null && feeConfigDC.lstFeeSchedulesConfig != null && feeConfigDC.lstFeeSchedulesConfig.Count() > 0)
                {
                    _feeLogic.SaveFeeSchedulesConfigLiability(new Guid(headerUserID), feeConfigDC.lstFeeSchedulesConfig);
                }
                _actionResult = new GenericResult()
                {
                    Succeeded = true,
        ...
        [Services.Controllers.IsAuthenticate]
        [Services.Controllers.DeflateCompression]
        [Route("api/feeconfiguration/getallfeefunctionsconfigliability")]
        public IActionResult GetAllFeefunctionsConfigLiability()
        {
            GenericResult _authenticationResult = null;
            List<FeeFunctionsConfigDataContract> _lstFeeFunctions = new List<FeeFunctionsConfigDataContract>();
            ...
            //if (permissionlist.Count > 0)
            //{
            _lstFeeFunctions = feeLogic.GetFeeFunctionsConfigLiability(headerUserID);
            //}
        ...
        [Services.Controllers.IsAuthenticate]
        [Services.Controllers.DeflateCompression]
        [Route("api/feeconfiguration/getallfeeschedulesconfigliability")]
        public IActionResult GetAllFeeSchedulesConfigLiability()
        {
            GenericResult _authenticationResult = null;
            List<FeeSchedulesConfigDataContract> _lstFeeSchedules = new List<FeeSchedulesConfigDataContract>();
            ...
            //if (permissionlist.Count > 0)
            //{
            _lstFeeSchedules = feeLogic.GetFeeSchedulesConfigLiability(headerUserID);
            //}
        ...
        [Services.Controllers.IsAuthenticate]
        [Services.Controllers.DeflateCompression]
        [Route("api/feeconfiguration/deletefeeschedulesconfigliability")]
        public IActionResult DeleteFeeSchedulesConfigLiabilityByID([FromBody] Guid FeeTypeGuID)
        {
            GenericResult _actionResult = null;
            IEnumerable<string> headerValues;
            string Validationmessage = string.Empty;
            ...
            {
                FeeConfigurationLogic _feeLogic = new FeeConfigurationLogic();
                _feeLogic.DeleteFeeSchedulesConfigLiabilityByID(new Guid(headerUserID), FeeTypeGuID);
                _actionResult = new GenericResult()
                {
                    Succeeded = true,
                    Message = "Fee schedule config deleted successfully",
        ...
        [Services.Controllers.IsAuthenticate]
        [Services.Controllers.DeflateCompression]
        [Route("api/feeconfiguration/deletefeefunctionsconfigliability")]
        public IActionResult DeleteFeeFunctionsConfigLiabilityByID([FromBody] Guid FunctionGuID)
        {
            GenericResult _actionResult = null;
            IEnumerable<string> headerValues;
            string Validationmessage = string.Empty;
            ...
            {
                FeeConfigurationLogic _feeLogic = new FeeConfigurationLogic();
                _feeLogic.DeleteFeeFunctionsConfigLiabilityByID(new Guid(headerUserID), FunctionGuID);
                _actionResult = new GenericResult()
                {
                    Succeeded = true,
                    Message = "Fee function config deleted successfully",
