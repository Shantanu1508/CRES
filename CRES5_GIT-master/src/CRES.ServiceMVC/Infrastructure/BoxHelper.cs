...
#pragma warning disable CS0414 // The field 'BoxHelper.BOX_CLIENT_ID' is assigned but its value is never used
        string BOX_CLIENT_ID = "";
#pragma warning restore CS0414 // The field 'BoxHelper.BOX_CLIENT_ID' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'BoxHelper.BOX_CLIENT_SECRET' is assigned but its value is never used
        string BOX_CLIENT_SECRET = "";
#pragma warning restore CS0414 // The field 'BoxHelper.BOX_CLIENT_SECRET' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'BoxHelper.ENTERPRISE_ID' is assigned but its value is never used
        string ENTERPRISE_ID = "";
#pragma warning restore CS0414 // The field 'BoxHelper.ENTERPRISE_ID' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'BoxHelper.JWT_PRIVATE_KEY_PASSWORD' is assigned but its value is never used
        string JWT_PRIVATE_KEY_PASSWORD = "";
#pragma warning restore CS0414 // The field 'BoxHelper.JWT_PRIVATE_KEY_PASSWORD' is assigned but its value is never used
#pragma warning disable CS0414 // The field 'BoxHelper.JWT_PUBLIC_KEY_ID' is assigned but its value is never used
        string JWT_PUBLIC_KEY_ID = "";
#pragma warning restore CS0414 // The field 'BoxHelper.JWT_PUBLIC_KEY_ID' is assigned but its value is never used
...
#pragma warning disable CS0618 // 'BoxSearchManager.SearchAsync(string, int, int, IEnumerable<string>, string, IEnumerable<string>, DateTime?, DateTime?, DateTime?, DateTime?, int?, int?, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, string, string, List<BoxMetadataFilterRequest>, string, BoxSortDirection?)' is obsolete: 'Method is deprecated; use QueryAsync() instead'
            var result = await client.SearchManager.SearchAsync(Box_Client_Folder, type: "folder");
#pragma warning restore CS0618 // 'BoxSearchManager.SearchAsync(string, int, int, IEnumerable<string>, string, IEnumerable<string>, DateTime?, DateTime?, DateTime?, DateTime?, int?, int?, IEnumerable<string>, IEnumerable<string>, IEnumerable<string>, string, string, List<BoxMetadataFilterRequest>, string, BoxSortDirection?)' is obsolete: 'Method is deprecated; use QueryAsync() instead'
...
#pragma warning disable CS0168 // The variable 'ex' is declared but never used
            ...
            {
#pragma warning disable CS0219 // The variable 'sr' is assigned but its value is never used
                string sr = "";
#pragma warning restore CS0219 // The variable 'sr' is assigned but its value is never used
                throw;
            }
...
#pragma warning disable CS0219 // The variable 'InvoicefolderID' is assigned but its value is never used
                string InvoicefolderID = "";
#pragma warning restore CS0219 // The variable 'InvoicefolderID' is assigned but its value is never used
...
#pragma warning disable CS0618 // 'BoxFilesManager.DownloadStreamAsync(string, string, TimeSpan?, int?, int?)' is obsolete: 'This method is deprecated in favor of DownloadAsync()'
                using (Stream stream = await client.FilesManager.DownloadStreamAsync(InvoiceFileId))
                {
                    int bytesRead;
...
#pragma warning restore CS0618 // 'BoxFilesManager.DownloadStreamAsync(string, string, TimeSpan?, int?, int?)' is obsolete: 'This method is deprecated in favor of DownloadAsync()'
            }
            catch (Exception ex)
            {
