...
{
    public class ExceluploadHelperLogic
    {
        ...
        public async Task<string> UploadXIRRFiles(ReportFileDataContract reportDC, DataTable dt)
        {
            string result = "";
            ...
            {              
                ...
                if (reportDC.ReportFileFormat.ToLower() == "xlsx")
                {
                    ...
                    using (var memStream = await AzureStorageRead.ReadAccountingReportStream(reportDC))
                    {
        ...
        public async void UploadXIRRFiles(ReportFileDataContract reportDC, DataTable dt, bool IsPrintHeader)
        {
            ...
            try
            {
                ...
                {
                    //read template from source
                    using (var memStream = AzureStorageRead.ReadAccountingReportInStream(reportDC))
                    {
