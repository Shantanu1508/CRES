...
--usp_GetInterestPaidTransactionEntry 'b0e6697b-3534-4c09-be0a-04473401ab93',  '2CCA48FA-B1AC-46CC-84B8-E4A7D8D92296','11168,11169,','9/7/2021','8/8/2022'
--[dbo].[usp_GetFixedPaymentAmortizationByDealID]  'b0e6697b-3534-4c09-be0a-04473401ab93',  '0f813461-56cf-48b8-b666-3d1f779a2d94','11747,11081,','9/7/2021','8/8/2022'
...
Select getdate() as DateWithoutAdjustment,p.Date,ROUND((Total),2) as Amount, ' + @ColPivot1 + '
From(
...
where p.Date between ''' + CAST(@StartDate  AS VARCHAR(100))   + ''' and ''' + CAST(@EndDate  AS VARCHAR(100))   + '''
order by p.date
'
