...
Select 
   ...
   ) row_num,NoteTransactionDetailID,NoteID,TransactionDate,TransactionType,Amount,RelatedtoModeledPMTDate,ModeledPayment,AmountOutstandingafterCurrentPayment,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,ServicingAmount,CalculatedAmount,Delta,M61Value,ServicerValue,Ignore,OverrideValue,comments,PostedDate,ServicerMasterID,ServicerName,Deleted,TransactionTypeText,TranscationReconciliationID,RemittanceDate,Exception,Adjustment,ActualDelta,OverrideReason,OverrideReasonText,Calculated,AllowCalculationOverride,TransactionEntryAmount,InterestAdj,AddlInterest,TotalInterest
From(
	...
	left join cre.NoteTransactionDetail nt on nt.NoteID = tr.NoteID and tr.Date = nt.RelatedtoModeledPMTDate and tr.Type = nt.TransactionTypeText
