-- Procedure  
 --   [dbo].[usp_GetAflac_TREPositions]  '{"Date":"12/10/2021"}' 
...
Select a.crenoteid,a.noteid,a.PeriodEndDAte,a.EndingBalance ,a.DueDate,a.RemitDate,a.Amount,a.SP_DueDate,a.SP_remitDate,(a.EndingBalance + a.SP_DueDate - a.SP_remitDate) as Reporting_EndingBalance
From(
	Select  n.crenoteid,nc.noteid,PeriodEndDAte,EndingBalance ,tblntd.DueDate,tblntd.RemitDate,tblntd.Amount,ISNULL(tblntd.Amount,0) as SP_DueDate,
...
Select   
 ...
 --FORMAT(nc.EndingBalance,'#,0.00') as POS_CUR_PAR, 
 ...
 CONVERT(varchar, @currentdatetime,101) as POS_DATE,  
 --FORMAT(n.AdjustedTotalCommitment,'#,0.00') as POS_FACE,  
 FORMAT(adj.TotalCurrentAdjustedCommitment,'#,0.00') as POS_FACE,  
 b.[Value] as MKT_PRICE,  
 'ACR' as SOURCE,  
 'LOAN' as CLIENT_SEC_TYPE,  
 lcurrency.name as SEC_CURRENCY,  
 'ACR' + FORMAT(CAST(n.crenoteid as int),'D6') as CLIENT_ID,  
 null as BOOK_TYPE,  
 null as BOOK_PRICE,  
