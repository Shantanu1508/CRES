--  [dbo].[usp_Get_AFLAC_DisclosureME]  '{"Date":"07/30/2021"}'

CREATE Procedure [dbo].[usp_Get_AFLAC_DisclosureME]  
(  
...
(
	...
	and fs1.FinancingSourceName in ('AFLAC US') 
...
Left Join( 
	Select noteid,(SUM(Amount)*-1) as PIKPrincipalFunding from cre.transactionEntry
...
and fs.FinancingSourceName in ('AFLAC US') --'AFLAC US',
