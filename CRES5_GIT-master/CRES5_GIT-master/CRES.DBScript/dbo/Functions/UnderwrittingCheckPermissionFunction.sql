Create Function [dbo].UnderwrittingCheckPermissionFunction(@LoginId nvarchar(256)= null,@Password nvarchar(256)= null,@DealID nvarchar(256)= null)
returns int
...
--Select UnderwrittingCheckPermissionFunction('10221','180 North LaSalle');
