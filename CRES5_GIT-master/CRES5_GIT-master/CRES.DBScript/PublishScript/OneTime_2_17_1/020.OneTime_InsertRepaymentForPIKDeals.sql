IF NOT EXISTS(SELECT 1 FROM sys.columns WHERE Name = N'Remark' AND Object_ID = Object_ID(N'cre.FundingRepaymentSequence'))
BEGIN
   ALTER TABLE [CRE].[FundingRepaymentSequence]  ADD [Remark] NVARCHAR (256) NULL
END

go

Print('Add the repayment sequence for PIK Deals')
