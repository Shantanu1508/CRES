CREATE TABLE [DW].[DealBI] (
    ...
    AlternateAssetManager2BI  nvarchar(256) null,
    AlternateAssetManager3BI  nvarchar(256) null,
...
GO
CREATE NONCLUSTERED INDEX [iCREDealID]
    ON [DW].[DealBI]([CREDealID] ASC);


GO
CREATE NONCLUSTERED INDEX [iDealName]
    ON [DW].[DealBI]([DealName] ASC);
