CREATE TABLE [DW].[NotePeriodicCalcBI] (
    ...
    [BSCurrentBalance]                             DECIMAL (28, 15) NULL,
...
CREATE NONCLUSTERED INDEX [iNotePeriodicCalcBI_NoteID_PeriodEndDate]
    ON [DW].[NotePeriodicCalcBI]([NoteID] ASC, [PeriodEndDate] ASC);


GO
CREATE NONCLUSTERED INDEX [nci_wi_NotePeriodicCalcBI_2C7146774C746B0F2A7EBF749105DC67]
    ON [DW].[NotePeriodicCalcBI]([AnalysisID] ASC, [AnalysisName] ASC, [PeriodEndDate] ASC)
    INCLUDE([CREDealID], [CRENoteID], [EndingBalance], [EndingGAAPBookValue], [InvestmentBasis], [NoteID]);
...
CREATE NONCLUSTERED INDEX [nci_wi_NotePeriodicCalcBI_D39CA8BBD76B99A18C7A34196C18BAA8]
    ON [DW].[NotePeriodicCalcBI]([NoteID] ASC, [AnalysisID] ASC)
    INCLUDE([CREDealID]);
