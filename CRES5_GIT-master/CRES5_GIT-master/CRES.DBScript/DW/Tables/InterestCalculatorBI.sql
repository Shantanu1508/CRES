CREATE TABLE [DW].[InterestCalculatorBI] (
...
GO
CREATE NONCLUSTERED INDEX [nci_wi_InterestCalculatorBI_811609E1DD7F671F3CECA5028F0FB4D4]
    ON [DW].[InterestCalculatorBI]([AnalysisID] ASC, [NoteID] ASC);
