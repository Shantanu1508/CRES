CREATE TABLE [CRE].[NotePeriodicCalcVSTO] (
    [NotePeriodicCalcVSTOID]                       INT              IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_NotePeriodicCalcVSTOID] PRIMARY KEY CLUSTERED ([NotePeriodicCalcVSTOID] ASC)
);
