...
{
    public class GeneralVerification : BaseClass
            ...
            try
            {
                ...
                if (loginValidation)
                {
                    ...
                    try
                    {
                        ...
                        transReconPage = driver.FindElement(deal.transReconPage).Displayed;
                    ...
                    {
                        Console.WriteLine("Calculation Manager Exception " + ex);
                    ...
                    {
                        Console.WriteLine("Note with exception tab Exception " + ex);
                    ...
                    {
                        Console.WriteLine("Batch Log Exception " + ex);
                        batchLogElmnt = false;
                        throw ex;
                    }
                    ...
                    {
                        Console.WriteLine("Report Exception " + ex);
                    ...
                    {
                        Console.WriteLine("Tags Exception " + ex);
                        addNewTagBtn = false;
                        throw ex;
                    }
                    ...
                    {
                        Console.WriteLine("Workflow Exception " + ex);
                        workflowElmnt = false;
                        throw ex;
                    }
                    ...
                    {
                        Console.WriteLine("Task Manager Exception " + ex);
                        addTaskBtn = false;
                        throw ex;
                    }
                    try
                    ...
                    {
                        Console.WriteLine("Task Manager Page Load Exception " + ex);
                        addTaskElmnt = false;
                        summaryElmnt = false;
                        throw ex;
                    }
                    ...
                    {
                        Console.WriteLine("Help Page Exception " + ex);
                        helpBtn = false;
        ...
        {
            {
                ...
                {
                    Console.WriteLine("Search bar Exception " + ex);
                }
            }
            /*   string path = ProjectBaseConfiguration.ExecutionReportFolder;
               EmailDataContract emailDC = new EmailDataContract();
