                    ...
                    try
                    {
                        ...
                        if (CalculationManagerTitle == "Calculation Manager")
                        {
                           ...
                           // Console.WriteLine("\nNoteId at =" + NoteId[0]);
                            ...
                            NotesCalculation.CreateExcelDataTableNew((DataTable)JsonConvert.DeserializeObject(JsonConvert.SerializeObject(ListNoteCalculation), (typeof(DataTable))), "NoteCalculationReport");
