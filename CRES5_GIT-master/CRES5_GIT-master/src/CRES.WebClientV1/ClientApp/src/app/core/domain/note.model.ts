...
export class Servicer {
  ServicerMasterID : number|null;
  ServicerDisplayName !: string;
  ServicerDropDate : number |null;
  RepaymentDropDate : number | null;

  constructor(ServicerMasterID : number|null, ServicerDropDate : number|null, RepaymentDropDate : number|null) {
