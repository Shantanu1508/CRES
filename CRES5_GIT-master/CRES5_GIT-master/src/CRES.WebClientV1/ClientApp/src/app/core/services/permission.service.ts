...
export class PermissionService {
  ...
  GetUserPermissionByPagename(pagename : any) {
  ...
  InsertUpdateUserPermissionByRoleID(moduleTabMasterList: any) {
  ...
  */
  ...
  UpdateAllowBasicLogin(_appConfig: any) {
