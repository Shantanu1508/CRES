...
export class WorkflowListComponent extends Paginated {
    ...
    private _workflow: Array<Workflow>;
    private _workflowObj: Workflow;
    private userobj: User;
    dealaddpath: any;
    private _workflowListFetching: boolean = false;
    private _ShowmessagedivMsgWar: boolean = false;
    private _dvEmptyWFSearchMsg: boolean = false;
