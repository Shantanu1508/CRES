...
export class ReportpageComponent extends Paginated {
    ...
    private _dvEmptyReportMsg: boolean = false;
    ...
    private _fetchingstatus: boolean = false;
    
    private _aftersubmitrequest: boolean = false;
    private _userrolecheck: boolean = false;
    private _otheruserscheck: boolean = false;
    private _checkstatusofuserrole: boolean = false;
    private _ispowerbistatus: boolean = false;
