import { Component, Inject, NgModule, Input, Output, EventEmitter } from "@angular/core";
import { Router, ActivatedRoute, Params } from '@angular/router';
import { TaskManagement } from "../core/domain/TaskManagement";
            ...
            this.taskManagerService.InsertUpdateTask(this._taskManagement).subscribe(res => {
                if (res.Succeeded) {                   
                    ...
                    if (this.taskid = "00000000-0000-0000-0000-000000000000") {
                        ...
                        Notificationmessage = _module + '|*|' + Notificationmessage + '|*|' + AppSettings._notificationenvironment;
