...
import { Note, DownloadCashFlow, NoteMarketPrice } from "../core/domain/Note";
import { NoteDateObjects } from "../core/domain/noteDateObjects";
...
import { NoteAdditionalList } from "../core/domain/NoteAdditionalList";
import { NoteAdditionalListObject } from "../core/domain/NoteAdditionalListObject";
...
import { ActivityLog } from "../core/domain/ActivityLog";
...
import { Scenario, RuleType } from "../core/domain/Scenario";
...
export class NoteDetailComponent extends Paginated {
    ...
    private _note: Note;
    private _noteDateObjects: NoteDateObjects;
    private _noteext: NoteAdditionalList;
    private _ruletype: RuleType;
    private _noteextt: NoteAdditionalListObject;
    private _validationobject: NoteAdditionalList;
    private lstnotesexceptions: any = [];
    private _ExceptionListCount: number = 1;
    public _CritialExceptionListCount: number = 1;
    private _ShowmessagedivWarnote: boolean = false;
    private _ShowmessagenotedivWar: boolean = false;
    private _Showmessagenotediv: boolean = false;

    private _noteArchieveext: NoteAdditionalList;
    private _noteArchieveextt: NoteAdditionalListObject;
    Message: any;
    private _isShowFuturefunding: boolean = false;
    public _isReadOnlyRuleTypeName: boolean = true;
    private _isShowAccounting: boolean = false;
    private _isShowClosing: boolean = false;
    private _isShowFinancing: boolean = false;
    private _isShowSettlement: boolean = false;
    private _isShowServicing: boolean = false;
    private _isShowServicelog: boolean = false;
    private _isShowPiksource: boolean = false;
    private _isShowFeecoupon: boolean = false;
    private _isShowLibor: boolean = false;
    private _isShowFixedamort: boolean = false;
    private _isShowPeriodicoutput: boolean = false;
    private _isshowsavenote: boolean = false;
    private _isShowCopynote: boolean = false;
    private _isShowCalcbutton: boolean = true;
    private _norecordfound: boolean = true;

    private _isShowServicingDropDate: boolean = false;
    ...
    private _liborindexMsg: boolean = true;
    private _showliborgride: boolean = false;
    ...
    private _isExceptionscount: boolean = false;
    private _isShowActivityLog: boolean = false;

    private _showamortcheck: boolean = false;
    private _showgaapcheck: boolean = false;
    ...
    private isActivityTday: boolean = false;
    private isActivityYday: boolean = false;
    private isActivityPday: boolean = false;
    ...
    private rssupdatedRowNo: any = [];
    private rssrowsToUpdate: any = [];
    private prepayrowsToUpdate: any = [];
    private prepayupdatedRowNo: any = [];
    private strippingrowsToUpdate: any = [];
    private strippingupdatedRowNo: any = [];
    private financingfeeupdatedRowNo: any = [];
    private financingfeerowsToUpdate: any = [];
    private flexfinancingschupdatedRowNo: any = [];
    private flexfinancingschrowsToUpdate: any = [];

    private flexdefaultschupdatedRowNo: any = [];
    private flexdefaultschrowsToUpdate: any = [];

    private flexfuturefundingupdatedRowNo: any = [];
    private flexfuturefundingrowsToUpdate: any = [];

    private flexPikupdatedRowNo: any = [];
    private flexPikrowsToUpdate: any = [];

    private flexLiborupdatedRowNo: any = [];
    private flexLiborrowsToUpdate: any = [];

    private flexFixedAmortupdatedRowNo: any = [];
    private flexFixedAmortrowsToUpdate: any = [];

    private flexfeecouponUpdatedRowNo: any = [];
    private flexfeecouponrowsToUpdate: any = [];

    private flexservicelogupdatedRowNo: any = [];
    private flexservicelogupdatedrow_num: any = [];
    private flexservicelogToUpdate: any = [];

    private PIKrowsToUpdate: any = [];

    private maturityupdatedrow: any = [];
    private pikupdatedrow: any = [];
    ...
    private ShowHideFlagMaturity: boolean = false;
    private ShowHideFlagBalanceTransactionSchedule: boolean = false;
    private ShowHideFlagDefaultSchedule: boolean = false;
    private ShowHideFlagFeeCouponSchedule: boolean = false;
    private ShowHideFlagFinancingFeeSchedule: boolean = false;
    private ShowHideFlagFinancingSchedule: boolean = false;
    private ShowHideFlagPIKSchedule: boolean = false;
    private ShowHideFlagPrepayAndAdditionalFeeSchedule: boolean = false;
    private ShowHideFlagRateSpreadSchedule: boolean = false;
    private ShowHideFlagServicingFeeSchedule: boolean = false;
    private ShowHideFlagStrippingSchedule: boolean = false;

    private ShowHideFlagFutureFunding: boolean = false;
    private ShowHideFlagLiborSchedule: boolean = false;
    private ShowFlagHideFixedAmortSchedule: boolean = false;
    private ShowHideFlagPIKfromPIKSourceNote: boolean = false;
    private ShowHideFlagFeeCouponStripReceivable: boolean = false;
    private isSaveOnly: boolean = false;
    private _islastCalcDateTime: boolean = true;
    ...
    private currentActivityDate: Date;
    private strActivity: string = '';
    private firstDat: string;

    private prevEndDateBeforeEdit: Date;
    ...
    private _isPeriodicDataFetched: boolean = true;
    private _isCalcDataFetched: boolean = false;
    private _isCalcJsonFetched: boolean = false;
    private _isCalcJsonResponseFetched: boolean = false;
    private _isCashFlowClicked: boolean = false;
    private _dvEmptyPeriodicDataMsg: boolean = false;
    private _isSetHeaderEmpty: boolean = false;
    private savedialogmsg: any;
    //additional data
    ...
    private _isShowDocImport: boolean = false;
    ...
    private prevDateBeforeEditMarketPrice: Date;
    ...
    private lstnotePeriodicOutputs: any;
    @ViewChild('flexnoteperiodiccalc') flexnoteperiodiccalc: wjcGrid.FlexGrid;

    private _isnoteperiodiccalcFetching: boolean = false;
    private _isnoteperiodiccalcFetched: boolean = false;
    @ViewChild('flexTransactionEntry') flexTransactionEntry: wjcGrid.FlexGrid;
    private _isTransactionEntryFetched: boolean = true;
    private _dvEmptynoteperiodiccalcMsg: boolean = false;
    private _divbatchuploadtext: boolean = false;
    ...
    */
    ...
    SendPushNotification(objectId: string): void {
        ...
        _notificationMsg = _module + '|*|' + _notificationMsg + '|*|' + AppSettings._notificationenvironment + '|*|' + _userData.UserID;
