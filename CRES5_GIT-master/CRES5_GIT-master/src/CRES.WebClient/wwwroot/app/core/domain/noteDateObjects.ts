export class NoteDateObjects {
    ...
    public MaturityEffectiveDate: Date;
    public FullyExtendedMaturityDate: Date;
    public MaturityDate: Date;
    public Servicing_EffectiveDate: Date;
    public Servicing_Date: Date;
    public PIKSchedule_EffectiveDate: Date;
    public PIKSchedule_StartDate: Date;
    public PIKSchedule_EndDate: Date;
    public Ratespread_EffectiveDate: Date;
    public PrepayAndAdditionalFeeSchedule_EffectiveDate: Date;
    public StrippingSchedule_EffectiveDate: Date;
    public FinancingFeeSchedule_EffectiveDate: Date;
