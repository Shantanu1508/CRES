(function (global, factory) {
	...
	(factory((global['ng2-file-input'] = {}),global.ng.core,global.platformBrowser,global.common,global.bergbenAngular2FileDrop));
}(this, (function (exports,core,platformBrowser,common,bergbenAngular2FileDrop) { 'use strict';
...
var Ng2FileInputComponent = (function () {
    function Ng2FileInputComponent(fileInputHandlerService, sanitizer, defaultOptions) {
        ...
        this.outputAction = new core.EventEmitter();
        this.outputRemoved = new core.EventEmitter();
        this.outputAdded = new core.EventEmitter();
        this.outputInvalidDenied = new core.EventEmitter();
        this.outputCouldNotRemove = new core.EventEmitter();
        this.outputCouldNotAdd = new core.EventEmitter();
    }
    ...
    Ng2FileInputComponent.decorators = [
    ...
    /** @nocollapse */
    Ng2FileInputComponent.ctorParameters = function () { return [
        { type: FileInputHandlerService, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return FileInputHandlerService; }),] },] },
        { type: platformBrowser.DomSanitizer, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return platformBrowser.DomSanitizer; }),] },] },
        { type: Ng2FileInputOptions, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return Ng2FileInputOptions; }),] },] },
    ]; };
    Ng2FileInputComponent.propDecorators = {
        "id": [{ type: core.Input },],
        "dropText": [{ type: core.Input, args: ['drop-text',] },],
        "browseText": [{ type: core.Input, args: ['browse-text',] },],
        "removeText": [{ type: core.Input, args: ['remove-text',] },],
        "invalidFileText": [{ type: core.Input, args: ['invalid-file-text',] },],
        "invalidFileTimeout": [{ type: core.Input, args: ['invalid-file-timeout',] },],
        "multiple": [{ type: core.Input, args: ['multiple',] },],
        "removable": [{ type: core.Input, args: ['removable',] },],
        "showPreviews": [{ type: core.Input, args: ['show-previews',] },],
        "extensions": [{ type: core.Input, args: ['extensions',] },],
        "outputAction": [{ type: core.Output, args: ['onAction',] },],
        "outputRemoved": [{ type: core.Output, args: ['onRemoved',] },],
        "outputAdded": [{ type: core.Output, args: ['onAdded',] },],
        "outputInvalidDenied": [{ type: core.Output, args: ['onInvalidDenied',] },],
        "outputCouldNotRemove": [{ type: core.Output, args: ['onCouldNotRemove',] },],
        "outputCouldNotAdd": [{ type: core.Output, args: ['onCouldNotAdd',] },],
    };
...
var USER_OPTIONS = new core.InjectionToken('ng2 file input custom user options');
