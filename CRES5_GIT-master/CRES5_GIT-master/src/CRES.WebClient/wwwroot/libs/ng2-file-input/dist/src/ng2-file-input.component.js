...
var Ng2FileInputComponent = (function () {
    ...
    Ng2FileInputComponent.ctorParameters = function () { return [
        ...
        { type: DomSanitizer, decorators: [{ type: Inject, args: [forwardRef(function () { return DomSanitizer; }),] },] },
        { type: Ng2FileInputOptions, decorators: [{ type: Inject, args: [forwardRef(function () { return Ng2FileInputOptions; }),] },] },
    ]; };
    Ng2FileInputComponent.propDecorators = {
        "id": [{ type: Input },],
        "dropText": [{ type: Input, args: ['drop-text',] },],
        "browseText": [{ type: Input, args: ['browse-text',] },],
        "removeText": [{ type: Input, args: ['remove-text',] },],
        "invalidFileText": [{ type: Input, args: ['invalid-file-text',] },],
        "invalidFileTimeout": [{ type: Input, args: ['invalid-file-timeout',] },],
        "multiple": [{ type: Input, args: ['multiple',] },],
        "removable": [{ type: Input, args: ['removable',] },],
        "showPreviews": [{ type: Input, args: ['show-previews',] },],
        "extensions": [{ type: Input, args: ['extensions',] },],
        "outputAction": [{ type: Output, args: ['onAction',] },],
        "outputRemoved": [{ type: Output, args: ['onRemoved',] },],
        "outputAdded": [{ type: Output, args: ['onAdded',] },],
        "outputInvalidDenied": [{ type: Output, args: ['onInvalidDenied',] },],
        "outputCouldNotRemove": [{ type: Output, args: ['onCouldNotRemove',] },],
        "outputCouldNotAdd": [{ type: Output, args: ['onCouldNotAdd',] },],
    };
