...
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'EffectiveDate_Prepay', N'data.notes.setup.effectivedate.dict', N'date', 1)
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'PrepayDate', N'data.notes.setup.effectivedate.dict', N'date', 1)
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'CalcThro', N'data.notes.setup.effectivedate.dict', N'date', 1)
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'PrepaymentMethod', N'data.notes.setup.effectivedate.dict', N'int', 1)
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'BaseAmount', N'data.notes.setup.effectivedate.dict', N'int', 1)
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'SpreadCalcMethod', N'data.notes.setup.effectivedate.dict', N'int', 1)
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'GreaterOfSMOrBaseAmtTimeSpread', N'data.notes.setup.effectivedate.dict', N'bool', 1)
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'ChkNoteLevel', N'data.notes.setup.effectivedate.dict', N'bool', 1)
INSERT [CRE].[JsonFormatCalcV1] ([Type], [Key], [Position], [DataType], [IsActive]) VALUES (N'PrepayPremium', N'IncludeFee', N'data.notes.setup.effectivedate.dict', N'bool', 1)
