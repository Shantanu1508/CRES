----INSERT INTO core.RateSpreadSchedule (EventId, Date, ValueTypeID,DeterminationDateHolidayListID,CreatedBy, CreatedDate,UpdatedBy,UpdatedDate)

--Select EventId, Date, 000 ValueTypeID,DeterminationDateHolidayListID,CreatedBy, CreatedDate,UpdatedBy,UpdatedDate
--from(
...
----and n.crenoteid = '7814'
----and lindex.name like '%SOFR%'
--)a
--order by 
--crenoteid,EffectiveStartDate  