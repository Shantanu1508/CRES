...
--Select credealid,dealname, 'exec [dbo].[usp_UpdateAutoRepayDataFromBackshopProduction] '''+a.CREDealID+''',''B0E6697B-3534-4C09-BE0A-04473401AB93'''
--From(
--	Select distinct d.dealid,credealid,dealname
--	from cre.note n 
