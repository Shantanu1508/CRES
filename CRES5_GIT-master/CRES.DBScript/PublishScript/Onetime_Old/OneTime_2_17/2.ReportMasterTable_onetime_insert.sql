...
update [App].[ReportFile] set IsAllowInput=1 where ReportFileID=6
update [App].[ReportFile] set IsAllowInput=1 where ReportFileID=8
update [App].[ReportFile] set IsAllowInput=1 where ReportFileID=3
update [App].[ReportFile] set IsAllowInput=1 where ReportFileID=7
update [App].[ReportFile] set IsAllowInput=1 where ReportFileID=9
update [App].[ReportFile] set IsAllowInput=1 where ReportFileID=1
update app.reportfile set IsAllowInput = 1 where reportfileid = 4
update app.reportfile set IsAllowInput = 1 where reportfileid = 2
update app.reportfile set IsAllowInput = 1 where reportfileid = 10
update app.reportfile set IsAllowInput = 1 where reportfileid = 5
update app.reportfilesheet set AdditionalParameters ='Custom_Date|A' where reportfileid = 4
update app.reportfilesheet set AdditionalParameters ='Custom_Month_End_Date|A' where reportfileid = 10
