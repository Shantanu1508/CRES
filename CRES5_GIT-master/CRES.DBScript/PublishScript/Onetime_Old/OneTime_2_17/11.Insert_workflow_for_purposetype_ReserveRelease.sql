...
--Select * from CRE.WFStatusPurposeMapping where PurposeTypeId=716

if not exists(select 1 from CRE.WFStatusPurposeMapping where PurposeTypeId=717)
begin
	INSERT INTO  CRE.WFStatusPurposeMapping(WFStatusMasterID,PurposeTypeId,OrderIndex,IsEnable)
	Select 
	WFStatusMasterID,
	717 as PurposeTypeId,
	(
	Case 
