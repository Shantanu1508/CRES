...
join core.Lookup l on l.LookupID=st.PurposeTypeId
join cre.dealfunding df on df.dealfundingid=w.TaskId and df.purposeid=st.PurposeTypeId
where (w.submittype=498 or w.submittype=497 or w.submittype=496)
and l.Value='Positive'
and w.isdeleted=0
