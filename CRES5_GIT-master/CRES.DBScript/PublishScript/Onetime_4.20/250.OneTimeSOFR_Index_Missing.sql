...
Declare	@UserID nvarchar(256) = 'B0E6697B-3534-4C09-BE0A-04473401AB93'
	...
	SET @StartDateTime = (Select MIN(Date) from core.Indexes where IndexType = @IndexTypeID and IndexesMasterID = (SELECT IndexesMasterID FROM core.IndexesMaster WHERE IndexesMasterGuid = @IndexesMasterGuid))
