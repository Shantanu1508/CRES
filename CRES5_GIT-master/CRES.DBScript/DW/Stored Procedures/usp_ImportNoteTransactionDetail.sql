...
--Declare @tblnote as table (NoteID UNIQUEIDENTIFIER)

--INSERT INTO @tblnote(NoteID)
--Select Distinct NoteID From(
--	Select	NoteID,[CreatedDate],[UpdatedDate]	From cre.NoteTransactionDetail
--	EXCEPT
--	Select	NoteId,[CreatedDate],[UpdatedDate]	From DW.NoteTransactionDetailBI
--)a
...
--IF EXISTS(Select NoteId from @tblnote)
--BEGIN
...
--WHERE nt.NoteID in (Select NoteId from @tblnote)
