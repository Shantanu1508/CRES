CREATE TABLE [DW].[NotePeriodicCalcByEntityBI_All] (
...
GO
CREATE NONCLUSTERED INDEX [iNotePeriodicCalcByEntityBI_All_NotePeriodicCalcAutoID]
    ON [DW].[NotePeriodicCalcByEntityBI_All]([NotePeriodicCalcAutoID] ASC);


GO
CREATE NONCLUSTERED INDEX [iNotePeriodicCalcByEntityBI_All_NoteID_PeriodEndDate]
    ON [DW].[NotePeriodicCalcByEntityBI_All]([NoteID] ASC, [PeriodEndDate] ASC);
