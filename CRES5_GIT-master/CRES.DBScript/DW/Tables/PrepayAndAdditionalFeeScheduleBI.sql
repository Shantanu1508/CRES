CREATE TABLE [DW].[PrepayAndAdditionalFeeScheduleBI] (
    [PrepayAndAdditionalFeeScheduleID]          UNIQUEIDENTIFIER NOT NULL,   
    [PrepayAndAdditionalFeeScheduleBI_AutoID] INT              IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_PrepayAndAdditionalFeeScheduleBI_AutoID] PRIMARY KEY CLUSTERED ([PrepayAndAdditionalFeeScheduleBI_AutoID] ASC)
);
