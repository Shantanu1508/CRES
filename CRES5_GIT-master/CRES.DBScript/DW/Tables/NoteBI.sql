...
GO
CREATE NONCLUSTERED INDEX [iCRENoteID]
    ON [DW].[NoteBI]([CRENoteID] ASC);


GO
CREATE NONCLUSTERED INDEX [iNote_AccountID]
    ON [DW].[NoteBI]([AccountID] ASC);


GO
CREATE NONCLUSTERED INDEX [iNote_DealID]
    ON [DW].[NoteBI]([DealID] ASC);
