CREATE TABLE [DW].[BackshopNoteFundingBI] (
    ...
    [BackshopNoteFundingBI_AutoID] INT              IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_BackshopNoteFundingBI_AutoID] PRIMARY KEY CLUSTERED ([BackshopNoteFundingBI_AutoID] ASC)
);
