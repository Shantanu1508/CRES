CREATE TABLE [DW].[L_RateSpreadScheduleBI] (
    ...
    [L_RateSpreadScheduleBI_AutoID] INT              IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_L_RateSpreadScheduleBI_AutoID] PRIMARY KEY CLUSTERED ([L_RateSpreadScheduleBI_AutoID] ASC)
);
