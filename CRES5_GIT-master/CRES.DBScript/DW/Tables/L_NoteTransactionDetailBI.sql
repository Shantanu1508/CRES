CREATE TABLE [DW].[L_NoteTransactionDetailBI] (
    ...
    [BatchLogID]                       INT              NULL,
    [L_NoteTransactionDetailBI_AutoID] INT              IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_L_NoteTransactionDetailBI_AutoID] PRIMARY KEY CLUSTERED ([L_NoteTransactionDetailBI_AutoID] ASC)
);
