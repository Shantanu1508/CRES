CREATE TABLE [DW].[NoteTransactionDetailBI] (
    ...
    [BatchLogID]                     INT              NULL,
    [NoteTransactionDetailBI_AutoID] INT              IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_NoteTransactionDetailBI_AutoID] PRIMARY KEY CLUSTERED ([NoteTransactionDetailBI_AutoID] ASC)
);
...
GO
CREATE NONCLUSTERED INDEX [i_NoteTransactionDetailBI_CRENoteID]
    ON [DW].[NoteTransactionDetailBI]([CRENoteID] ASC);
