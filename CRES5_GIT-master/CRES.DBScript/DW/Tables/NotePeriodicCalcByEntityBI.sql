CREATE TABLE [DW].[NotePeriodicCalcByEntityBI] (
    [NotePeriodicCalcByEntity_AutoID]            INT              IDENTITY (1, 1) NOT NULL,
    [NotePeriodicCalcAutoID]                     INT              NULL,
    ...
    CONSTRAINT [PK_NotePeriodicCalcByEntityBI_NotePeriodicCalcByEntity_AutoID] PRIMARY KEY CLUSTERED ([NotePeriodicCalcByEntity_AutoID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [iNotePeriodicCalcByEntityBI_NoteID_PeriodEndDate]
    ON [DW].[NotePeriodicCalcByEntityBI]([NoteID] ASC, [PeriodEndDate] ASC);


GO
CREATE NONCLUSTERED INDEX [iNotePeriodicCalcByEntityBI_NotePeriodicCalcAutoID]
    ON [DW].[NotePeriodicCalcByEntityBI]([NotePeriodicCalcAutoID] ASC);
