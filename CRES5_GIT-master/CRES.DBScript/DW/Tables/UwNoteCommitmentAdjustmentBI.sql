CREATE TABLE [DW].[UwNoteCommitmentAdjustmentBI] (
    ...
    [UwNoteCommitmentAdjustmentBI_AutoID] INT              IDENTITY (1, 1) NOT NULL,
    CONSTRAINT [PK_UwNoteCommitmentAdjustmentBI_AutoID] PRIMARY KEY CLUSTERED ([UwNoteCommitmentAdjustmentBI_AutoID] ASC)
);
