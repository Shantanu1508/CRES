CREATE TABLE [DW].[Prod_Cashflow] (
    ...
    CONSTRAINT [PK_NotePeriodicCalcIDProd] PRIMARY KEY CLUSTERED ([NotePeriodicCalcID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [iNotePeriodicCalcProd_NoteID_PeriodEndDate]
    ON [DW].[Prod_Cashflow]([NoteID] ASC, [PeriodEndDate] ASC);
