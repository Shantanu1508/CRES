CREATE PROCEDURE [VAL].[usp_GetProjectedPayoffCalc]  --'21-2086'
	@MarkedDate date,
...
BEGIN  
	...
	Where 1 = (CASE WHEN @CREDealid is null THEN 1 WHEN p.ControlID = @CREDealid THEN 1 ELSE 0 END ) 
