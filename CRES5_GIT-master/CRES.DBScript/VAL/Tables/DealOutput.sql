CREATE TABLE [VAL].[DealOutput] (    
	DealOutputID    INT    IDENTITY (1, 1) NOT NULL,	
    ...
    CONSTRAINT [PK_DealOutput_DealOutputID] PRIMARY KEY CLUSTERED ([DealOutputID] ASC),
	CONSTRAINT [FK_DealOutput_MarkedDateMasterID] FOREIGN KEY (MarkedDateMasterID) REFERENCES [VAL].[MarkedDateMaster] (MarkedDateMasterID) 
);
