CREATE TABLE [VAL].[DealOutputArchive] (    
	DealOutputArchiveID    INT    IDENTITY (1, 1) NOT NULL,	
	ArchiveMasterID    INT,
    ...
    CONSTRAINT [PK_DealOutputArchive_DealOutputArchiveID] PRIMARY KEY CLUSTERED ([DealOutputArchiveID] ASC),
	CONSTRAINT [PK_DealOutputArchive_ArchiveMasterID] FOREIGN KEY (ArchiveMasterID) REFERENCES [VAL].[ArchiveMaster] (ArchiveMasterID) 
);
