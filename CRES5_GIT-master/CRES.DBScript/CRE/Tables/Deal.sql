CREATE TABLE [CRE].[Deal] (
    ...
    [BalanceAware]                         BIT              DEFAULT ((0)) NULL,
    ...
    [AllowGaapComponentInCashflowDownload] INT              NULL,
    [WatchlistStatus]                      NVARCHAR (256)   NULL,
    [AccountID]                            UNIQUEIDENTIFIER NULL,
    [StateFromProperty]   NVARCHAR (256) NULL,
    RealizedUnRealized nvarchar(256) null,
    linkeddealidXIRR nvarchar(256) null,
    EnableAutoDistributePrincipalWriteoff BIT DEFAULT ((0)) NULL,
	PrepaymentGroupSize                   INT              NULL,
	PrepaymentAllocationMethod            INT              NULL,
