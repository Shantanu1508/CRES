CREATE TABLE [CRE].[Note] (
    ...
    PIKCalculationRuleForPaydownsAmort	                   INT              NULL,
    PIKCalculationRuleForPaydowns                          INT              NULL,
    FirstIndexDeterminationDateOverride                     date null,
    AccrualPeriodType                                      INT              NULL,
    AccrualPeriodBusinessDayAdj                            INT              NULL,
    AccountingClose INT null,
	[InterestCalculationRuleForPIKPaydowns]                   INT              NULL,
    ServicingStatusBS                                   NVARCHAR (256)   NULL,
    [WeightedSpread]                                   DECIMAL (28, 15) NULL,
	UPBAtForeclosure                            decimal (28,15),
    FullIOTermFlag          int,
    [NetCapitalInvested]                           DECIMAL (28, 15) NULL,
    [NoteType]                                     INT              NULL,
    [ClosingDateBK]                                 DATE            NULL,
	[InterestOnlyNote]                              INT              NULL,
	[ConstantPaymentMethod]                         INT              NULL,
	[PaymentDateAccrualPeriod]                      INT              NULL
