...
INSERT INTO [CRE].[TransactionEntryClose]
	...
	and ((@BatchCalculationMasterID is not null and NoteID in (Select NoteID FROM [Core].BatchCalculationDetail where BatchCalculationMasterID =@BatchCalculationMasterID))
