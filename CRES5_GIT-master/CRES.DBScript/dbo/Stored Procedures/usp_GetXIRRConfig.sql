...
CREATE PROCEDURE [dbo].[usp_GetXIRRConfig] 
AS  
BEGIN  
...
,ISNULL(tblConfigrequest.[Status], '') as 'Status'
,ErrorDetail.ErrorDetails
,xc.RowNumber
,xc.Group1
,xc.Group2
,xc.ArchivalRequirement
,l1.Name as ArchivalRequirementText
,xc.ReferencingDealLevelReturn
,xc.UpdateXIRRLinkedDeal
,l2.Name as UpdateXIRRLinkedDealText
,xc.[Type]
...
left join core.lookup l1 on l1.lookupid = xc.ArchivalRequirement  
left join core.lookup l2 on l2.lookupid = xc.UpdateXIRRLinkedDeal 
LEFT JOIN (
