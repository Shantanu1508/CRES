...
BEGIN  
 ...
 SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED  
	...
	SELECT  tt.TransactionTypesID
		   ...
		   ,tt.AccountName
		    ,tt.UsedInXIRR
			,l6.Name as UsedInXIRRText
			,tt.XIRRCategory
			,l7.LookupID as IsClubTransactionOnSameDate
			,l7.[Name] as IsClubTransactionOnSameDateText
	...
	left join core.lookup l6 on l6.LookupID = tt.UsedInXIRR
	left join core.lookup l7 on l7.LookupID = tt.IsClubTransactionOnSameDate
