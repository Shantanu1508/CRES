...
CREATE PROCEDURE [dbo].[usp_SetElasticQuery_ImportFromProduction]  
AS  
BEGIN  
...
CREATE DATABASE SCOPED CREDENTIAL CredentialCRESStaging  WITH IDENTITY = 'AcoreProd',  SECRET = 'rB^`6eB3LsbX=Fx'
