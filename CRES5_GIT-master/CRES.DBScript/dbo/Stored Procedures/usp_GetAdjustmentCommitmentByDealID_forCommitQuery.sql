...
--	END
	...
	----===========PivotingTempTable====================--------------
		...
		--SET @query =N'
		--			SELECT Distinct [Type],[Date],TypeText,CommitmentType
		...
		SELECT Distinct @DealID as DealID,[Type],[Date],TypeText,CommitmentType
					FROM #TempDataPivotTable
					Order By Date asc
