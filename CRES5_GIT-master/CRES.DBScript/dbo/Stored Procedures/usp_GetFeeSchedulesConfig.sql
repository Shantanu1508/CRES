...
CREATE Procedure [dbo].[usp_GetFeeSchedulesConfig]
@UserID NVarchar(255)
...
BEGIN
	...
	IsUsedInCalc = Case when exists(select 1 from [CORE].PrepayAndAdditionalFeeSchedule where ValueTypeID=FS.FeeTypeNameID) then 1 else 0 end,
