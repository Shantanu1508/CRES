...
CREATE PROCEDURE [dbo].[usp_LCFeeSchedulesConfig] 
...
SET FMTONLY OFF;
   ...
   Select	
	...
	feetranstype.Name as FeeNameTransIDText
	...
	LEFT JOIN [CORE].[Lookup] LInterestPaymentID ON LInterestPaymentID.LookupID = FS.InterestPaymentID AND LInterestPaymentID.ParentID=91
 	LEFT JOIN [CORE].[Lookup] feetranstype ON feetranstype.LookupID = FS.FeeNameTransID
