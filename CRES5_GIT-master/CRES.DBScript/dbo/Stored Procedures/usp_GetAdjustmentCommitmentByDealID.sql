...
--  [dbo].[usp_GetAdjustmentCommitmentByDealID]'b0e6697b-3534-4c09-be0a-04473401ab93','C7F38B99-BC29-4433-946C-A606E516BB15'
...
--BEGIN
		...
		---=========================ClosingDate Query==============================------------
		INSERT INTO #TempDataTable(NoteAdjustedCommitmentMasterID,CRENoteID,NoteID,[Type],[Date],TypeText,DealAdjustmentHistory,AdjustedCommitment,TotalCommitment,
		AggregatedCommitment,NoteAdjustedCommitment,NoteTotalCommitment,NoteAggregatedCommitment,Comments,lienposition,[priority],InitialFundingAmount,NoteName,TotalRequiredEquity,TotalAdditionalEquity, Amount,CommitmentType,ExcludeFromCommitmentCalculation,TotalEquityatClosing)
		...
		TotalCommitment,AggregatedCommitment,NoteAdjustedCommitment,NoteTotalCommitment,NoteAggregatedCommitment,Comments,lienposition,[priority],InitialFundingAmount,NoteName,TotalRequiredEquity,TotalAdditionalEquity,Amount,CommitmentType,ExcludeFromCommitmentCalculation,TotalEquityatClosing)
		SELECT  0,
				n.CRENoteID, 
				n.NoteID,
				'638' as Type,
...
--	END
	...
	----===========PivotingTempTable====================--------------
		...
		SET @query =N'
					SELECT NoteAdjustedCommitmentMasterID,Type,Date,TypeText,DealAdjustmentHistory,AdjustedCommitment,TotalCommitment,AggregatedCommitment,TotalRequiredEquity,TotalAdditionalEquity,Comments,' + @ColPivot1 + ',CommitmentType,ExcludeFromCommitmentCalculation,TotalEquityatClosing
					FROM (
					...
					ISNULL(Amount,0) as Amount,CommitmentType,ISNULL(ExcludeFromCommitmentCalculation,0) as ExcludeFromCommitmentCalculation,TotalEquityatClosing
