...
BEGIN
	...
	Select 	CalculationRequestID,	NoteId,	RequestTime,	StatusID,	UserName,	ApplicationID,	StartTime,	EndTime,	ServerName,	PriorityID,	ErrorMessage,	ErrorDetails,	ServerIndex,	AnalysisID,	CalculationModeID,	CalcBatch,	NumberOfRetries,	DealID,	RequestID,	CalcType 	
