...
CREATE PROCEDURE [dbo].[usp_Recon_PortfolioReconDateWise]
AS  
BEGIN  
...
ABS((ISNULL(DEV_Amount,0)- ISNULL(STG_Amount,0))) as ABS_Delta,n.ClosingDate, n.ActualPayoffDate, c.Status as Calculation_Status, @AnalysisNameDev as Dev_Scenario,@AnalysisNameStg as Staging_Scenario, l2.Name as Note_Status, pik.PIK_Note, le.Name as EnableM61Calculations --, IOTermEndDate_Dev, TransactionDateByRule_Dev, TransactionDateByRule_Stg , RemitDate_Dev,RemitDate_Stg,  FeeTypeName_Dev , FeeTypeName_Stg
...
left join cre.Note n on n.NoteID=ISNULL(n.NoteID ,b.noteid)
