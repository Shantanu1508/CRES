...
BEGIN  
	...
	,(CASE WHEN @IsPIKNote = 1 THEN ISNULL(PIKInterestAddedToBalanceBasedOnBusinessAdjustedDate,3) Else PIKInterestAddedToBalanceBasedOnBusinessAdjustedDate END) as PIKInterestAddedToBalanceBasedOnBusinessAdjustedDate  
	,(CASE WHEN @IsPIKNote = 1 THEN ISNULL(lPIKInterestAddedToBalanceBasedOnBusinessAdjustedDate.name,'Y') Else lPIKInterestAddedToBalanceBasedOnBusinessAdjustedDate.name END) as PIKInterestAddedToBalanceBasedOnBusinessAdjustedDateText  
