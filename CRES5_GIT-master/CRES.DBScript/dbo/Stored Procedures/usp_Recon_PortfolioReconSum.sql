-- Procedure
CREATE PROCEDURE [dbo].[usp_Recon_PortfolioReconSum]
AS  
BEGIN  
...
from (
	...
	Group by n.NoteID, Type,  AnalysisID 
) a
full outer join (
...
and ISNULL(a.Type,b.type) Not in ( 'EndingPVGAAPBookValue') --in (@TransactionType)
