...
CREATE PROCEDURE [DBO].[usp_CheckDuplicateDealSettlement] 
(
...
BEGIN
 ...
 set @Functionres = (select( DBO.ufn_UnderwrittingCheckPermissionFunction_Settlement(@Username,@Password,@CREDealID))); 
