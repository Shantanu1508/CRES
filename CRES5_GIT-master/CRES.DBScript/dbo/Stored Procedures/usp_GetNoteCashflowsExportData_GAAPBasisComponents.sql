...
BEGIN  
 ...
 Select n.CRENoteID as [Note Id]  
 ,acc.name as [Note Name]  
 ,CAST(CONVERT(VARCHAR, [Date], 101) as Date)as [Date]  
 ,AccumAmortofDeferredFees as [Accum Amort of Deferred Fees]  
 ,AccumulatedAmortofDiscountPremium as [Accumulated Amort of Discount Premium]  
 ,AccumulatedAmortofCapitalizedCost as [Accumulated Amort of Capitalized Cost]  
 ,EndingBalance as [Ending Balance]    
 ,GrossDeferredFees as  [Gross Deferred Fees]     
 ,CleanCost as [Clean Cost]    
 ,CurrentPeriodInterestAccrual as [Current Period Interest Accrual Period Enddate]    
 ,CurrentPeriodPIKInterestAccrual as [Current Period PIKInterest Accrual Period Enddate]    
 ,InterestSuspenseAccountBalance as [Interest Suspense Account Balance]   
 ...
 and d.AllowGaapComponentInCashflowDownload = 3
...
BEGIN  
 ...
 ,GrossDeferredFees     
 ,CleanCost    
 --,CurrentPeriodInterestAccrual as CurrentPeriodInterestAccrualPeriodEnddate    
