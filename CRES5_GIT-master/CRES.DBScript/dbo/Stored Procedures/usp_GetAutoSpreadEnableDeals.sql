CREATE PROCEDURE [dbo].[usp_GetAutoSpreadEnableDeals] 
...
BEGIN
	  ...
	  SELECT DealID
			...
			,l8.Name as AutospredRepayments
  ...
  FROM CRE.Deal d
	...
	left Join Core.Lookup l8 on d.EnableAutoSpreadRepayments=l7.LookupID
...
Where IsDeleted <> 1 and EnableAutoSpreadRepayments = 1 and status = 323
