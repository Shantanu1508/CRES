...
--[dbo].[usp_Liability_Onetime_TransactionEntryLiability_UploadTransactionTabOnly] '7/16/2025'


CREATE PROCEDURE [dbo].[usp_Liability_Onetime_TransactionEntryLiability_UploadTransactionTabOnly]   
(  
	@gCutoffdate Date
)   
...
Delete from [CRE].[TransactionEntryLiability] where ParentAccountId = @equityAccountID and AnalysisID = 'C10F3372-0FC2-4861-A9F5-148F1F80804F' 
...
,1 as Confirmed	
,'EquityCapitalAllocation' Comments	 
...
,[Transaction] as [Transaction Amount]
,1 as [Confirmed]
, 'EquityCapitalAllocation' as Comments
