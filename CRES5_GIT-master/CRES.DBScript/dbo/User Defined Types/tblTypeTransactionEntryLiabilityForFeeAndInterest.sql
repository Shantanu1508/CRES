--drop PROCEDURE usp_InsertTransactionEntryLiabilityForFeeAndInterest
--drop TYPE tblTypeTransactionEntryLiabilityForFeeAndInterest
CREATE TYPE [dbo].[tblTypeTransactionEntryLiabilityForFeeAndInterest] AS TABLE(
