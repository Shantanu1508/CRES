-- View
CREATE VIEW [dbo].[vw_Recon_PortfolioReconDateWise]
AS  

Select d.DealName,d.CREDealID, n.CRENoteID, ISNULL(a.Type,b.type) as [Type],a.date as DEV_Date , DEV_Amount, b.date as STG_Date,STG_Amount, 
(ISNULL(DEV_Amount,0)- ISNULL(STG_Amount,0)) as Delta,
ABS((ISNULL(DEV_Amount,0)- ISNULL(STG_Amount,0))) as ABS_Delta,n.ClosingDate, n.ActualPayoffDate, c.Status as Calculation_Status, 'Default' as Dev_Scenario,'Default'  as Staging_Scenario, l2.Name as Note_Status, pik.PIK_Note, le.Name as EnableM61Calculations --, IOTermEndDate_Dev, TransactionDateByRule_Dev, TransactionDateByRule_Stg , RemitDate_Dev,RemitDate_Stg,  FeeTypeName_Dev , FeeTypeName_Stg
...
from (
	...
	Where AnalysisID='C10F3372-0FC2-4861-A9F5-148F1F80804F'  ---@AnalysisID_dev
	--and te.noteid = 'B940AD6F-631B-4C5D-8871-9BEF7C6F5AE2'
	Group by NoteID, Type, date, AnalysisID , IOTermEndDate, transactionDateByRule , RemitDate , FeeTypeName
) a
full outer join (
	...
	Where AnalysisID='C10F3372-0FC2-4861-A9F5-148F1F80804F' ----@AnalysisID_Stg
	...
	inner join(
		...
		Where ste1.AnalysisID='C10F3372-0FC2-4861-A9F5-148F1F80804F' --@AnalysisID_Stg
	...
	Where ste.AnalysisID='C10F3372-0FC2-4861-A9F5-148F1F80804F' ---@AnalysisID_Stg
...
Select CreNoteID, l.Name as Status from cre.Note n
	...
	Where cr.AnalysisID='C10F3372-0FC2-4861-A9F5-148F1F80804F' --@AnalysisID_dev
...
and (iSNULL(a.AnalysisID,b.AnalysisID) ='C10F3372-0FC2-4861-A9F5-148F1F80804F' ---@AnalysisID_dev  
OR iSNULL(a.AnalysisID,b.AnalysisID) ='C10F3372-0FC2-4861-A9F5-148F1F80804F' ) --@AnalysisID_Stg
and n.EnableM61Calculations=3

--and ISNULL(a.Type,b.type)  like '%PIKInt%'
and ISNULL(a.Type,b.type) NOT in( 'EndingPVGAAPBookValue','UnusedFeeExcludedFromLevelYield','PIKInterestPercentage')
and ABS((ISNULL(Dev_Amount,0)- ISNULL(Stg_Amount,0))) > 0
--and n.ClosingDate>= '2022-06-01 00:00:00.000'
--and c.Status='Completed'
--and n.CRENoteID in ('19682')
--and d.DealName<>'Grandview Multifamily Portfolio_Copy'
