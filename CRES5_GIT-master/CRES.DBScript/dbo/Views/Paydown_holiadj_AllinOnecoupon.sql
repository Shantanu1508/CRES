CREATE View [dbo].Paydown_holiadj_AllinOnecoupon
as
Select 
DealName
, Status
...
and Day(Date)>= 8  
and Noteid = '1779'
--order By DealName, Noteid, Date
--Where 
-- USe the Day(Date) for upaid Interest transactions. Comment it for Interest variance.
