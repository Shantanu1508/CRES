...
where Noteid in (Select Distinct N.CreNoteid
				...
				where tr.type not in ( 'FundingOrRepayment')  
				and tr.AccountTypeID = 1
				and Tr.[Date] <= EOMONTH(DateAdd(month,2,EOMONTH(n.ClosingDate)))  and InitialFundingAmount < 1 and tr.AnalysisID = 'C10F3372-0FC2-4861-A9F5-148F1F80804F'
				)
