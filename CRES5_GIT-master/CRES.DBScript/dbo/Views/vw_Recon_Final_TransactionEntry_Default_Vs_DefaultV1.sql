CREATE VIEW [dbo].[vw_Recon_Final_TransactionEntry_Default_Vs_DefaultV1]  
 AS  
...
, SUM(test.DevAmount) as DevAmount, SUM(Stg.StgAmount) as StgAmount, SUM((Test.DevAmount)-(Stg.StgAmount)) as Delta, Test.ClosingDate, Test.ActualPayoffDate, Test.CalcStatus, Test.CalcEngineType  as DefaultCalcEngine,  stg.StgCalcEngineType as StgCalcEngineType
from   (
...
from Cre.TransactionEntry ste
	...
	left join core.Lookup l on l.LookupID=cr.StatusID 
	left join core.Lookup leng on leng.LookupID=cr.CalcEngineType 
	Where cr.AnalysisID='95bdfff7-0760-4d51-8c5d-c5e50ed179d1' 
)cr on cr.AccountId = n.Account_AccountID
Inner join core.Analysis a on a.AnalysisID = ste.AnalysisID
Where ste.AnalysisID='95bdfff7-0760-4d51-8c5d-c5e50ed179d1' 
