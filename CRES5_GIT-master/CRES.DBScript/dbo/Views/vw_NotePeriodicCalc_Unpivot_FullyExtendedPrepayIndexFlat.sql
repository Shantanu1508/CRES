...
CREATE VIEW [dbo].[vw_NotePeriodicCalc_Unpivot_FullyExtendedPrepayIndexFlat]  
...
From(  
 ...
 where nc.analysisID = '726671fa-16a9-44f6-af71-5d54492e7e82' and nc.[month] is not null  
 and acc.isdeleted <> 1  
 and d.isdeleted <> 1  
)a  
UNPIVOT   
