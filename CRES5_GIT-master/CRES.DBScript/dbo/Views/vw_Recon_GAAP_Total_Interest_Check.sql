CREATE VIEW [dbo].[vw_Recon_GAAP_Total_Interest_Check]  
...
Select      DealName
			...
			[Month],
			PeriodEndDate ,
			CalcGAAPIntInc= (CurrentPeriodInterestAccrual+CurrentPeriodPIKInterestAccrual+ ReversalofPriorInterestAccrual+InterestReceivedinCurrentPeriod),
