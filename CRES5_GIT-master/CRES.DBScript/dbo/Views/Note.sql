...
n.OriginationFeePercentageRP
 ...
 ,Active_paidoff_Bi= Case when ISNULL( Actualpayoffdate,Fullyextendedmaturitydate)<= '12/31/2018'  then 'Paidoff before 2018'
		when ISNULL( Actualpayoffdate,Fullyextendedmaturitydate)<= '12/31/2019'  then 'Paidoff before 2019'
		when ISNULL( Actualpayoffdate,Fullyextendedmaturitydate)> '12/31/2019'  then 'Paidoff aftr 2019'
		when Actualpayoffdate is  null then 'Active'
		end

,n.FinancingSourceGroup
...
,n.FinancingSourceID
 ...
 ,[ImpactCommitmentCalcBI] as [ImpactCommitmentCalc] 
,NoteTypeBI as NoteType
,EnableM61CalculationsBI as EnableM61Calculations
