...
CREATE View [dbo].[NotePeriodicCalcByEntity_All_ExpectedMaturityDate_withPrepay_FWCVShiftDownward50bps]    
as    
...
where AnalysisID in ('6B4415BB-B467-4D20-9DDA-6C016C174236')

--AnalysisName in ('Expected Maturity Date (with Prepay, FWCV Shift Downward 50bps)')
