...
CREATE VIEW [dbo].[vw_Recon_Final_TransactionEntry_SameDB_Default_Vs_ExpectedMatFWCV] 
 ...
 AS   
	...
	full outer join ( 
		...
		Left join( 
			...
			Where cr.AnalysisID='d8f8af6d-b9c7-4015-a610-41d34941eeb52'  
			and cr.CalcEngineType = 797  
		)cr on cr.AccountId = n.Account_AccountID 
