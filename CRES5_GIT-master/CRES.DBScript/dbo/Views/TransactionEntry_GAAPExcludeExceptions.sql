CREATE View [dbo].[TransactionEntry_GAAPExcludeExceptions]
as
...
and T.NoteID not in (Select nn.noteid from [dbo].[Staging_Cashflow] np
...
and T.Noteid not in (Select  Distinct nn.Noteid 
...
and N.noteid not in ('4338','5526','100','Tuscon Phtm B','RXR_B','Phtm West QD B','IC_Hapuna Upsize_A',
...
--and N.Noteid not in 	('RXR_B','1275','3844','3841','Vill_B','4463','2723','3843','1323','Phtm Post M',
...
and N.Noteid not in ('9809','2905','9193','3571','6594','9810')--PikLoans
