CREATE View [dbo].[IntgrationInterest_withoutFinalPayoffinterest]
as
select 
NoteID as NoteKey,
...
outer apply (Select MAX(T1.Date) Date, CRENoteID from  [DW].[TransactionEntryBI] T1
				...
				and 	T.Type =  T1.Type and T.AnalysisID = T1.AnalysisID
				Group by T1.CRENoteID

				)X
Where Type = 'InterestPaid' and T.Date < x.Date

--and T.creNoteid ='9247' and T.Date = '4/8/2019'
