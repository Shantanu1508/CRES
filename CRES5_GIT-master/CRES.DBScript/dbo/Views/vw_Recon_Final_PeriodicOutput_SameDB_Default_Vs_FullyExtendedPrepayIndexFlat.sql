...
CREATE VIEW [dbo].[vw_Recon_Final_PeriodicOutput_SameDB_Default_Vs_FullyExtendedPrepayIndexFlat]  
 AS  
...
full outer join (
	Select * from dbo.vw_NotePeriodicCalc_Unpivot_FullyExtendedPrepayIndexFlat
