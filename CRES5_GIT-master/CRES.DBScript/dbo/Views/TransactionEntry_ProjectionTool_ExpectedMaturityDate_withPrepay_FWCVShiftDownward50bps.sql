CREATE VIEW [dbo].[TransactionEntry_ProjectionTool_ExpectedMaturityDate_withPrepay_FWCVShiftDownward50bps]
AS
select     
T.NoteID as NoteKey,    
...
Where T.analysisID = '6B4415BB-B467-4D20-9DDA-6C016C174236' --- in (Select analysisID from core.analysis where [Name] in ('Expected Maturity Date (with Prepay, FWCV Shift Downward)') )  
