create view [dbo].[vw_Disc_ForWireConfirmed]   
AS  
 ...
 ,Cast(ROUND(df.RequiredEquity,2) as decimal(28,2)) as RequiredEquity
 ,Cast(ROUND(df.AdditionalEquity,2) as decimal(28,2)) as AdditionalEquity
