CREATE VIEW [dbo].[vw_Recon_Final_PeriodicOutput_Default_Vs_DefaultC#]  
 AS  
...
SUM(a.Value) as DevAmount ,SUM(b.Value) as StgAmount, SUM(a.Value-b.Value) as Delta,  n.closingDate as ClosingDate, 
